...
const FALLBACK_SEED_POLLS: Poll[] = [
  ...
  {
    id: "a4040404-4444-4444-8888-444444444444",
    question: "Preference on Unified Pension Scheme (UPS) vs National Pension System (NPS)?",
    description: "Historical employee opinion survey completed regarding retirement security choices under modern state frameworks.",
    category: "General",
    allow_multiple: false,
    show_results_before_vote: true,
    allow_vote_edit: false,
    ...
    options: [
      {
        id: "e1010101-1111-4444-8888-111111111111",
        poll_id: "a4040404-4444-4444-8888-444444444444",
        option_text: "Restore Old Pension Scheme (OPS) Entirely",
        display_order: 1,
        vote_count: 2210
      },
      {
        id: "e2020202-2222-4444-8888-222222222222",
        poll_id: "a4040404-4444-4444-8888-444444444444",
        option_text: "Support Unified Pension Scheme (UPS)",
        display_order: 2,
        vote_count: 730
      },
      {
        id: "e3030303-3333-4444-8888-333333333333",
        poll_id: "a4040404-4444-4444-8888-444444444444",
        option_text: "Enhance NPS Equity Allocation Flexibility",
        display_order: 3,
        vote_count: 180
      }
    ]
